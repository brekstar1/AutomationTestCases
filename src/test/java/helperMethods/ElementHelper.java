...
public class ElementHelper {
    ...
    public void validateMessageContains(By locator, String expectedMessage) {
        waitForVisible(locator);
        WebElement element = driver.findElement(locator);
        String actualMessage = element.getText();
        Assert.assertTrue(actualMessage.contains(expectedMessage),"Mesajul nu este afisat corect.");
    }
